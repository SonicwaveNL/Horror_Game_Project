...
main: main.o game.o player.o IObject.o wall.o support.o actions.o door.o windowHandler.o inputHandler.o inputListener.o keyboardMouse.o
...
game.o: game.cpp game.hpp IObject.hpp windowHandler.hpp inputHandler.hpp actions.hpp
	gcc -c game.cpp game.hpp IObject.hpp windowHandler.hpp inputHandler.hpp game.o

player.o: player.cpp player.hpp IObject.hpp
	gcc -c player.cpp player.hpp IObject.hpp -o player.o
...
clean:
	$(rm) main.o game.o player.o IObject.o wall.o support.o actions.o door.o windowHandler.o inputHandler.o inputListener.o keyboardMouse.o
