...
game.o: game.cpp game.hpp action.hpp gridCell.hpp iObject.hpp monster.hpp player.hpp support.hpp switch.hpp uiElement.hpp iException.hpp floor.hpp
...
main: action.o door.o floor.o fileFactory.o game.o gridCell.o inputHandler.o inputListener.o iObject.o iRectangle.o keyboardMouse.o monster.o player.o switch.o wall.o uiElement.o main.o
	$(gcc) -o Booh action.o door.o floor.o fileFactory.o game.o gridCell.o inputHandler.o inputListener.o iObject.o iRectangle.o keyboardMouse.o monster.o player.o switch.o wall.o uiElement.o main.o $(LIBS)

clean:
	$(rm) main.o game.o player.o wall.o support.o door.o windowHandler.o inputHandler.o inputListener.o keyboardMouse.o action.o floor.o fileFactory.o gridCell.o iObject.o iRectangle.o monster.o switch.o uiElement.o Booh
