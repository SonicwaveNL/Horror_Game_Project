...
fileFactory.o: fileFactory.hpp fileFactory.cpp support.hpp gridCell.hpp wall.hpp player.hpp monster.hpp switch.hpp door.hpp
...
uiElement.o : uiElement.hpp uiElement.cpp iRectangle.hpp
...
main: action.o door.o fileFactory.o game.o gridCell.o inputHandler.o inputListener.o iObject.o iRectangle.o keyboardMouse.o monster.o player.o switch.o wall.o main.o uiElement.o
	$(gcc) -o Booh action.o door.o fileFactory.o game.o gridCell.o inputHandler.o inputListener.o iObject.o iRectangle.o keyboardMouse.o monster.o player.o switch.o wall.o main.o uiElement.o $(LIBS)
