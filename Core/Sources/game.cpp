            ...
            case gameState::Play:
                ...
                // monster movement loop
                {
                    ...
                    if (monster->getPosition() ==
                      ...
                      std::cout << "monster pos: " << monster->getPosition().x << ", " << monster->getPosition().y << std::endl;
                      std::cout << "gridPos: " <<  grid[myXPos][myYPos].getPosition().x << ", " << grid[myXPos][myYPos].getPosition().y << std::endl;
                        monster->moveOld();
                    }
                }
